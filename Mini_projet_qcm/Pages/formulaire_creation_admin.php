...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/formulaire_creation_admin.css?refresh=<?php echo rand();?>">
        ...
        <div class="formulaire">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="avatar">
                    Avatar
                    <!--
                    <div id="yourBt" onclick="getFile()">Changer Avatar</div>
                     this is your file input tag, so i hide it!-->
                    <!-- i used the onchange event to fire the form submission-->
                    <!--
                    <div style='height: 0px;width: 0px; overflow:hidden;'><input  id="upfil" name="avatar" value="upload" /></div>-->

                    <input class="choix_fichier" type="file" name="avatars" accept="image/*" onchange="loadFile(event);">
                </div>
